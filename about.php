...
<body class="sub_page">
  ...
  <section class="about_section layout_padding layout_margin" style="background: #17d355;">
    <div class="container  ">
      <div class="row">
        <div class="col-md-6">
          <div class="detail-box">
            ...
            <a href="" style="background: #f8e538;">
              Read More
            </a>
          </div>
        </div>
        <div class="col-md-6 ">
          <div class="img-box">
            <img src="images/pp.jpg" alt="" style="height:400px;">
          </div>
        </div>
